            ...
            <div className="flex-1 p-4 min-h-0 overflow-auto">
              <div className="w-full border h-full shadow-xl rounded-lg bg-white overflow-auto">
                ...
                <div className="w-[90%] h-[250px] ml-[60px] mt-10 border border-gray-300 rounded-2xl mb-10">
                  ...
                  <div className=" flex justify-between w-full h-[60px] border-t border-b border-gray-300 mt-10 cursor-pointer bg-gray-100">
                    <div className="mt-4 ">
                      <span className="text-[13px] ml-5 font-semibold text-blue-500">
                        Review your login activity
                      </span>
                    </div>

                    <div className="mt-4 ">
                      <span className="text-[22px] mr-[40px]">
                        <AiOutlineRight />
                      </span>
                    </div>
                  </div>
