                ...
                <div className="lg:flex lg:flex-row lg:gap-4 xl:flex xl:flex-row xl:gap-4 md:flex md:flex-col md:gap-4 sm:flex sm:flex-col sm:gap-4 xsm:flex xsm:flex-col xsm:gap-4 px-4">
                    <div className="bg-gray-100 rounded-xl shadow-lg border bg-white h-full w-[40%] xl:w-[40%] lg:w-[40%] md:w-full sm:w-full p-4">
                        ...
                        <div className='relative'>
                            ...
                            <label 
                                for="fileUpload"
                                className='block w-[20rem] h-10 p-2 text-sm text-gray-900 bg-gray-400 rounded-md border border-gray-400 cursor-pointe'
                            >
                                SELECT FILE
                            </label>
                        </div>
                        <div className='flex flex-row gap-4 pt-10 justify-start'>
                            <div className='pt-1'>
                                <span className='text-[15px] text-gray-700 font-semibold'>DOCTYPE</span>
                            </div>
                            <div>
                                <input type="text" 
                                    id='uploadDoctype'
                        ...
                        <div className='flex flex-col gap-4 pt-10 justify-center'>
                            <div>
                                <span className='text-base text-gray-700 font-semibold mt-4'>INDEX</span>         
                            </div>
                        </div>
                        ...
                        <div className='flex flex-row gap-4 justify-center'>
                            <div className="dropdown inline-block relative  pt-3 pb-5">
								<div className="">
									<FiLink size={20} className='text-white text-sm sm:absolute sm:top-[45%] sm:left-[7%] -translate-y-1/2'   />
									...
									<div className="flex w-full">
										<div className="w-full">
                                            ...
                                            <div className='relative left-[11rem] pt-3 pb-2'>
												...
												>
													<FiLink size={20} className='text-white text-sm absolute top-[50%] left-[4%] -translate-y-1/2' />
														Send
												</button>
											</div>
										</div>
